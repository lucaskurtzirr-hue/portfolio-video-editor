...
layout: default
title: Home
description: Video Editor Portfolio for Gaming Creators
---
...
<section id="contato" class="section">
  <div class="container">
    ...
    <h2 lang="pt">Contato</h2>

    <p class="section-intro" lang="en">[Placeholder — Invite for project inquiry.]</p>
    <p class="section-intro" lang="pt">[Placeholder — Convite para orçamento ou job.]</p>

    <ul class="contact-list">
      <li><strong>Email:</strong> [Placeholder — email]</li>
      <li><strong>Discord / WhatsApp:</strong> [Placeholder — channel]</li>
      <li>
        <strong lang="en">Socials:</strong>
        <strong lang="pt">Redes:</strong> 
        [Placeholder — links]
      </li>
    </ul>
  </div>
